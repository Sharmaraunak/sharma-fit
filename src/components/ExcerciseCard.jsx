  ...
  return (
    <div className="p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm: flex-wrap">
      <div className="flex flex-col sm:flex-row sm: items-center sm:flex-wrap gap-x-4">
        ...
        <p className="capitalize text-sm text-slate-400 ">{excercise?.type}</p>
      </div>
      ...
      <div className="flex flex-col bg-slate-950 gap-2">
        {excercise?.description?.split("___").map((val, index) => {
          return (
      ...
      <div className="grid grid-cols-2 sm: grid-cols-4 sm:place-item-center gap-2">
        ...
        <button
          ...
          className="flex flex-col p-2 rounded border-[1.5px] duration-200 border-blue-900 hover: border-blue-600 w-full "
        >
